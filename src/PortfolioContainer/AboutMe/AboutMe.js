            ...
            <div className="about-me-parent">
                ...
                <div className="about-me-card">
                   ...
                   <div className="about-me-trait"></div>
                        <p>Après une carrière comme chirurgien dentiste, souhaitant continuer à rendre service et à utiliser mes mains comme
                            le prolongement de mon cerveau, c'est tout naturellement que je me suis tournée vers
                            une reconversion dans le développement web. 
                            J'ai ainsi validé une première formation de développeuse web chez OpenClassrooms. Ayant à coeur de sans cesse progresser et apprendre,
                            j'ai pousuivi une formation de développeuse d'application Javascript - React.js.<br/>
                            ...
                            Ayant une appétence pour le Frontend , je suis  passionnée  par React.js et son écosystème mais le backend (Node.js) n'est jamais loin non plus.
